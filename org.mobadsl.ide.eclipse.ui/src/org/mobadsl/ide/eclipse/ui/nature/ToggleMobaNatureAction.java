...
public class ToggleMobaNatureAction implements IObjectActionDelegate {

	private static final org.slf4j.Logger log = LoggerFactory
			.getLogger(ToggleMobaNatureAction.class);
	...
	public void toggleNature(IProject project) {
		try {
			...
			for (int i = 0; i < natures.length; ++i) {
				if (MobaNature.NATURE_ID.equals(natures[i])) {
					// Remove the nature
			...
			newNatures[natures.length] = MobaNature.NATURE_ID;
			description.setNatureIds(newNatures);
			project.setDescription(description, null);
