define(["ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules"], function(oop, mText, mTextHighlightRules) {
	var HighlightRules = function() {
		var keywords = "0|1|ContentTypeHeader|DELETE|GET|POST|PUT|RawHeader|active|alias|application|as|attachment|authorization|autorization|backgroundApp|beacon|bigData|cache|cascading|const|constraints|contextDto|copyright|custom|datatype|digits|domainDescription|domainKey|dto|embed|enter|entity|enum|errorDto|event|extends|extensionPoint|format|friends|generator|headers|id|index|interval|isArray|isBool|isDate|isDecimal|isDefault|isHidden|isNotNull|isNull|isNumeric|isPredefined|isPrimitive|isString|isTime|isTimestamp|isUndefined|javaPackage|lazy|leave|lit|lowEnergy|max|maxLength|method|min|minLength|mixin|multipart|opposite|param|parameters|path|persistence|project|queue|ref|refEntity|refParam|regexp|requestDto|responseDto|rest|restCrud|restWorkflow|serialization|server|service|services|settings|slot|spp|strategy|text|toFirstLower|toFirstUpper|toLowerCase|toUpperCase|transient|type|uiApp|unique|url|using|var|version|wraps";
		this.$rules = {
			"start": [
				{token: "lparen", regex: "[\\[({]"},
				{token: "rparen", regex: "[\\])}]"},
