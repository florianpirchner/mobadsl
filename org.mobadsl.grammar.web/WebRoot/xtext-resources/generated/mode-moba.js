define("xtext-resources/generated/mode-moba", ["ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules"], function(oop, mText, mTextHighlightRules) {
	var HighlightRules = function() {
		var keywords = "0|1|DELETE|GET|POST|active|alias|application|as|authorization|autorizations|backgroundApp|beacon|bigData|cache|cascading|const|constraints|custom|datatype|default|digits|domainDescription|domainKey|dto|enter|entity|enum|errorDto|event|extends|extensionPoint|friends|generator|headers|id|index|isArray|isDate|isDecimal|isNotNull|isNull|isNumeric|isPrimitive|isString|isTime|isTimestamp|lazy|leave|lit|max|maxLength|method|min|minLength|mixin|param|parameters|project|queue|ref|regexp|requestDto|responseDto|rest|restCrud|restWorkflow|serialization|server|service|services|settings|slot|spp|strategy|text|transient|type|uiApp|url|var|version";
		this.$rules = {
			"start": [
				{token: "comment", regex: "\\/\\/.*$"},
