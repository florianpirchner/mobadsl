		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMobaEnumLiteralAccess().getGroup_7(), "rule__MobaEnumLiteral__Group_7__0");
					...
					put(grammarAccess.getMobaEnumLiteralAccess().getDefaultAssignment_7_1(), "rule__MobaEnumLiteral__DefaultAssignment_7_1");
