		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMobaRESTCustomServiceAccess().getAuthorizationAssignment_6_2_2(), "rule__MobaRESTCustomService__AuthorizationAssignment_6_2_2");
					put(grammarAccess.getMobaRESTCustomServiceAccess().getRequestDtoAssignment_6_3_2(), "rule__MobaRESTCustomService__RequestDtoAssignment_6_3_2");
					put(grammarAccess.getMobaRESTCustomServiceAccess().getResponseDtoAssignment_6_4_2(), "rule__MobaRESTCustomService__ResponseDtoAssignment_6_4_2");
					put(grammarAccess.getMobaRESTCustomServiceAccess().getErrorDtoAssignment_6_5_2(), "rule__MobaRESTCustomService__ErrorDtoAssignment_6_5_2");
					put(grammarAccess.getMobaRESTCustomServiceAccess().getOperationAssignment_6_6_2(), "rule__MobaRESTCustomService__OperationAssignment_6_6_2");
					...
					put(grammarAccess.getMobaRestHeaderAccess().getNameStringAssignment_0_1_0(), "rule__MobaRestHeader__NameStringAssignment_0_1_0");
					put(grammarAccess.getMobaRestHeaderAccess().getNameConstAssignment_0_1_1(), "rule__MobaRestHeader__NameConstAssignment_0_1_1");
					put(grammarAccess.getMobaRestHeaderAccess().getRawHeaderAssignment_1_0(), "rule__MobaRestHeader__RawHeaderAssignment_1_0");
					put(grammarAccess.getMobaRestHeaderAccess().getNameStringAssignment_1_1_0(), "rule__MobaRestHeader__NameStringAssignment_1_1_0");
					put(grammarAccess.getMobaRestHeaderAccess().getNameConstAssignment_1_1_1(), "rule__MobaRestHeader__NameConstAssignment_1_1_1");
					...
					put(grammarAccess.getMobaRestHeaderAccess().getValueIntAssignment_1_3_1(), "rule__MobaRestHeader__ValueIntAssignment_1_3_1");
					put(grammarAccess.getMobaRestHeaderAccess().getValueDoubleAssignment_1_3_2(), "rule__MobaRestHeader__ValueDoubleAssignment_1_3_2");
					put(grammarAccess.getMobaRestHeaderAccess().getValueConstAssignment_1_3_3(), "rule__MobaRestHeader__ValueConstAssignment_1_3_3");
