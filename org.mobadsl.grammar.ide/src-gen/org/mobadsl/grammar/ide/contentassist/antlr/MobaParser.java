		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMobaEntityAttributeAccess().getGroup_1_5(), "rule__MobaEntityAttribute__Group_1_5__0");
					put(grammarAccess.getMobaEntityAttributeAccess().getGroup_1_5_3(), "rule__MobaEntityAttribute__Group_1_5_3__0");
					...
					put(grammarAccess.getMobaDtoAttributeAccess().getGroup_1_5_3(), "rule__MobaDtoAttribute__Group_1_5_3__0");
					put(grammarAccess.getMobaDtoAttributeAccess().getGroup_1_6(), "rule__MobaDtoAttribute__Group_1_6__0");
					...
					put(grammarAccess.getMobaEntityAttributeAccess().getFormatStringAssignment_1_4_2_0(), "rule__MobaEntityAttribute__FormatStringAssignment_1_4_2_0");
					put(grammarAccess.getMobaEntityAttributeAccess().getFormatConstAssignment_1_4_2_1(), "rule__MobaEntityAttribute__FormatConstAssignment_1_4_2_1");
					put(grammarAccess.getMobaEntityAttributeAccess().getConstraintsAssignment_1_5_2(), "rule__MobaEntityAttribute__ConstraintsAssignment_1_5_2");
					put(grammarAccess.getMobaEntityAttributeAccess().getConstraintsAssignment_1_5_3_1(), "rule__MobaEntityAttribute__ConstraintsAssignment_1_5_3_1");
					...
					put(grammarAccess.getMobaSettingsAttributeAccess().getFormatStringAssignment_1_4_2_0(), "rule__MobaSettingsAttribute__FormatStringAssignment_1_4_2_0");
					put(grammarAccess.getMobaSettingsAttributeAccess().getFormatConstAssignment_1_4_2_1(), "rule__MobaSettingsAttribute__FormatConstAssignment_1_4_2_1");
					put(grammarAccess.getMobaSettingsAttributeAccess().getConstraintsAssignment_1_5_2(), "rule__MobaSettingsAttribute__ConstraintsAssignment_1_5_2");
					...
					put(grammarAccess.getMobaDtoAttributeAccess().getFormatStringAssignment_1_4_2_0(), "rule__MobaDtoAttribute__FormatStringAssignment_1_4_2_0");
					put(grammarAccess.getMobaDtoAttributeAccess().getFormatConstAssignment_1_4_2_1(), "rule__MobaDtoAttribute__FormatConstAssignment_1_4_2_1");
					put(grammarAccess.getMobaDtoAttributeAccess().getConstraintsAssignment_1_5_2(), "rule__MobaDtoAttribute__ConstraintsAssignment_1_5_2");
					put(grammarAccess.getMobaDtoAttributeAccess().getConstraintsAssignment_1_5_3_1(), "rule__MobaDtoAttribute__ConstraintsAssignment_1_5_3_1");
					put(grammarAccess.getMobaDtoAttributeAccess().getAliasAssignment_1_6_2(), "rule__MobaDtoAttribute__AliasAssignment_1_6_2");
					...
					put(grammarAccess.getMobaDtoReferenceAccess().getOppositeAssignment_5_1(), "rule__MobaDtoReference__OppositeAssignment_5_1");
