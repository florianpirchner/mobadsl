...
/**
 * This is the item provider adapter for a {@link org.mobadsl.semantic.model.moba.MobaPayloadAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MobaPayloadAttributeItemProvider extends MobaPayloadFeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MobaPayloadAttributeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_lazy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_lazy_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__LAZY,
				 true,
				 false,
				 false,
	...
	protected void addTransientPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_transient_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_transient_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__TRANSIENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addDomainKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_domainKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_domainKey_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__DOMAIN_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addDomainDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_domainDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_domainDescription_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__DOMAIN_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addAliasPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_alias_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_alias_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__ALIAS,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaPayloadAttribute_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaPayloadAttribute_type_feature", "_UI_MobaPayloadAttribute_type"),
				 MobaPackage.Literals.MOBA_PAYLOAD_ATTRIBUTE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns MobaPayloadAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MobaPayloadAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((MobaPayloadAttribute)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MobaPayloadAttribute_type") :
			getString("_UI_MobaPayloadAttribute_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MobaPayloadAttribute.class)) {
