...
/**
 * This is the item provider adapter for a {@link org.mobadsl.semantic.model.moba.MobaServer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MobaServerItemProvider extends MobaApplicationFeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MobaServerItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addServicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaServer_services_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaServer_services_feature", "_UI_MobaServer_type"),
				 MobaPackage.Literals.MOBA_SERVER__SERVICES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAuthorizationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaServer_authorization_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaServer_authorization_feature", "_UI_MobaServer_type"),
				 MobaPackage.Literals.MOBA_SERVER__AUTHORIZATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MobaServer"));
	}
