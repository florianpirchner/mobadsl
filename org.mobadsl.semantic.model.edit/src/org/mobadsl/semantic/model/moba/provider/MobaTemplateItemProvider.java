 ...
 * @generated
 */
public class MobaTemplateItemProvider extends MobaApplicationFeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MobaTemplateItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MobaTemplate_template_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MobaTemplate_template_feature", "_UI_MobaTemplate_type"),
				 MobaPackage.Literals.MOBA_TEMPLATE__TEMPLATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MobaTemplate"));
	}
