...
/**
 * This is the item provider adapter for a {@link org.mobadsl.semantic.model.moba.index.MobaIndex} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MobaIndexItemProvider 
	 ...
	 * @generated
	 */
	public MobaIndexItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MobaIndexPackage.Literals.MOBA_INDEX__ENTRIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MobaIndex"));
	}
	...
	public String getText(Object object) {
		String label = ((MobaIndex)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MobaIndex_type") :
			getString("_UI_MobaIndex_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MobaIndexPackage.Literals.MOBA_INDEX__ENTRIES,
				 MobaIndexFactory.eINSTANCE.createMobaIndexEntry()));
	}
