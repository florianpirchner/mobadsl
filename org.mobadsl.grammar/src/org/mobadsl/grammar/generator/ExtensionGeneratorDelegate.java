...
public class ExtensionGeneratorDelegate {
	 ...
	 * @return
	 */
	public Map<String, IGeneratorDelegate> readExtentions(String grammarName, List<String> generatorIds) {
	 ...
	 * @return
	 */
	public Map<String, Metadata> readExtentionsMetadata(String grammarName, List<String> generatorIds) {
		IExtensionRegistry registry = Platform.getExtensionRegistry();
		IExtensionPoint point = registry.getExtensionPoint("org.mobadsl.grammar", INFERRER_HOOK_EXTPT);
		if (point == null) {
			return Collections.emptyMap();
