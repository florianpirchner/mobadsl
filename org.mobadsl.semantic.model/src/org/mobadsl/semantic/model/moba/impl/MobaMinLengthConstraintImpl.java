 ...
 * <em><b>Min Length Constraint</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaMinLengthConstraintImpl#getFilterValue <em>Filter Value</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaMinLengthConstraintImpl#getFilterConst <em>Filter Const</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaMinLengthConstraintImpl extends MobaConstraintImpl implements MobaMinLengthConstraint {

	private static final Logger LOGGER = LoggerFactory.getLogger(MobaMinLengthConstraintImpl.class);
	 ...
	 * @generated
	 */
	protected MobaMinLengthConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MobaPackage.Literals.MOBA_MIN_LENGTH_CONSTRAINT;
	}
	...
	public void setFilterValue(int newFilterValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_MIN_LENGTH_CONSTRAINT__FILTER_VALUE, oldFilterValue, filterValue));
	}
	...
	public MobaConstant getFilterConst() {
		if (filterConst != null && filterConst.eIsProxy()) {
			...
			if (filterConst != oldFilterConst) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MobaPackage.MOBA_MIN_LENGTH_CONSTRAINT__FILTER_CONST, oldFilterConst, filterConst));
			}
		}
		return filterConst;
	}
	...
	public void setFilterConst(MobaConstant newFilterConst) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_MIN_LENGTH_CONSTRAINT__FILTER_CONST, oldFilterConst, filterConst));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MobaPackage.MOBA_MIN_LENGTH_CONSTRAINT__FILTER_CONST:
