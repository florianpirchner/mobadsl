 ...
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaQueueImpl#getCache <em>Cache</em>}</li>
...
public class MobaQueueImpl extends MobaDataImpl implements MobaQueue {
	...
	public MobaCache getCache() {
		if (cache != null && cache.eIsProxy()) {
			...
			if (cache != oldCache) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MobaPackage.MOBA_QUEUE__CACHE, oldCache, cache));
			}
		}
		return cache;
	}
	...
	public void setCache(MobaCache newCache) {
		...
		cache = newCache;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_QUEUE__CACHE, oldCache, cache));
	}
