 ...
 * </p>
 * <ul>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getCache <em>Cache</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaBeanImpl#getIndex <em>Index</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaBeanImpl extends MobaDataImpl implements MobaBean {
	...
	public EList<MobaProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<MobaProperty>(MobaProperty.class, this, MobaPackage.MOBA_BEAN__PROPERTIES);
		}
		return properties;
	}
	...
	public MobaBean getSuperType() {
		if (superType != null && superType.eIsProxy()) {
			...
			if (superType != oldSuperType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MobaPackage.MOBA_BEAN__SUPER_TYPE, oldSuperType, superType));
			}
		}
		return superType;
	}
	...
	public void setSuperType(MobaBean newSuperType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_BEAN__SUPER_TYPE, oldSuperType, superType));
	}
	...
	public NotificationChain basicSetCache(MobaCache newCache, NotificationChain msgs) {
		...
		cache = newCache;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_BEAN__CACHE, oldCache, newCache);
	...
	public void setCache(MobaCache newCache) {
		if (newCache != cache) {
			...
			if (cache != null)
				msgs = ((InternalEObject)cache).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_BEAN__CACHE, null, msgs);
			if (newCache != null)
				msgs = ((InternalEObject)newCache).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_BEAN__CACHE, null, msgs);
	...
	public EList<MobaBeanFeature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<MobaBeanFeature>(MobaBeanFeature.class, this, MobaPackage.MOBA_BEAN__FEATURES);
		}
		return features;
	}
	...
	public NotificationChain basicSetIndex(MobaBeanIndex newIndex, NotificationChain msgs) {
		...
		index = newIndex;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_BEAN__INDEX, oldIndex, newIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIndex(MobaBeanIndex newIndex) {
		if (newIndex != index) {
			NotificationChain msgs = null;
			if (index != null)
				msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_BEAN__INDEX, null, msgs);
			if (newIndex != null)
				msgs = ((InternalEObject)newIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_BEAN__INDEX, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesAble.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_BEAN__PROPERTIES: return MobaPackage.MOBA_PROPERTIES_ABLE__PROPERTIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesAble.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_PROPERTIES_ABLE__PROPERTIES: return MobaPackage.MOBA_BEAN__PROPERTIES;
				default: return -1;
			}
		}
