...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Settings Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class MobaSettingsAttributeImpl extends MobaSettingsFeatureImpl implements MobaSettingsAttribute {
	/**
	 ...
	 * @generated
	 */
	protected MobaSettingsAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MobaPackage.Literals.MOBA_SETTINGS_ATTRIBUTE;
	}
	...
	public NotificationChain basicSetMultiplicity(MobaMuliplicity newMultiplicity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__MULTIPLICITY, oldMultiplicity, newMultiplicity);
	...
	public void setMultiplicity(MobaMuliplicity newMultiplicity) {
		if (newMultiplicity != multiplicity) {
			...
			if (multiplicity != null)
				msgs = ((InternalEObject)multiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_SETTINGS_ATTRIBUTE__MULTIPLICITY, null, msgs);
			if (newMultiplicity != null)
				msgs = ((InternalEObject)newMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_SETTINGS_ATTRIBUTE__MULTIPLICITY, null, msgs);
			msgs = basicSetMultiplicity(newMultiplicity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__MULTIPLICITY, newMultiplicity, newMultiplicity));
	}
	...
	public void setLazy(boolean newLazy) {
		...
		lazy = newLazy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__LAZY, oldLazy, lazy));
	}
	...
	public void setTransient(boolean newTransient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__TRANSIENT, oldTransient, transient_));
	}
	...
	public void setDomainKey(boolean newDomainKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__DOMAIN_KEY, oldDomainKey, domainKey));
	}
	...
	public void setDomainDescription(boolean newDomainDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__DOMAIN_DESCRIPTION, oldDomainDescription, domainDescription));
	}
	...
	public MobaDataType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(MobaDataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_SETTINGS_ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaMultiplicityAble.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_SETTINGS_ATTRIBUTE__MULTIPLICITY: return MobaPackage.MOBA_MULTIPLICITY_ABLE__MULTIPLICITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == MobaConstraintable.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_CONSTRAINTABLE__CONSTRAINTS: return MobaPackage.MOBA_SETTINGS_ATTRIBUTE__CONSTRAINTS;
				default: return -1;
			}
		}
