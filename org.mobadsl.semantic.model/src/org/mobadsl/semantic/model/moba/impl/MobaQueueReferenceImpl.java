 ...
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaQueueReferenceImpl#getProperties <em>Properties</em>}</li>
 ...
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaQueueReferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaQueueReferenceImpl extends MobaQueueFeatureImpl implements MobaQueueReference {
	...
	public EList<MobaProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<MobaProperty>(MobaProperty.class, this, MobaPackage.MOBA_QUEUE_REFERENCE__PROPERTIES);
		}
		return properties;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_QUEUE_REFERENCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MobaPackage.MOBA_QUEUE_REFERENCE__TYPE:
				...
				return basicGetType();
			case MobaPackage.MOBA_QUEUE_REFERENCE__NAME:
				return getName();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaMultiplicityProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_QUEUE_REFERENCE__MULTIPLICITY: return MobaPackage.MOBA_MULTIPLICITY_PROVIDER__MULTIPLICITY;
				default: return -1;
			}
		}
		if (baseClass == MobaPropertiesProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_QUEUE_REFERENCE__PROPERTIES: return MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaMultiplicityProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_MULTIPLICITY_PROVIDER__MULTIPLICITY: return MobaPackage.MOBA_QUEUE_REFERENCE__MULTIPLICITY;
				default: return -1;
			}
		}
		if (baseClass == MobaPropertiesProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES: return MobaPackage.MOBA_QUEUE_REFERENCE__PROPERTIES;
				default: return -1;
			}
		}
