 ...
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaDtoImpl#getCache <em>Cache</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaDtoImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaDtoImpl#getIndex <em>Index</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaDtoImpl extends MobaDataImpl implements MobaDto {
	...
	public NotificationChain basicSetCache(MobaCache newCache, NotificationChain msgs) {
		...
		cache = newCache;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_DTO__CACHE, oldCache, newCache);
	...
	public void setCache(MobaCache newCache) {
		if (newCache != cache) {
			...
			if (cache != null)
				msgs = ((InternalEObject)cache).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_DTO__CACHE, null, msgs);
			if (newCache != null)
				msgs = ((InternalEObject)newCache).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_DTO__CACHE, null, msgs);
	...
	public NotificationChain basicSetIndex(MobaDtoIndex newIndex, NotificationChain msgs) {
		...
		index = newIndex;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_DTO__INDEX, oldIndex, newIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIndex(MobaDtoIndex newIndex) {
		if (newIndex != index) {
			NotificationChain msgs = null;
			if (index != null)
				msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_DTO__INDEX, null, msgs);
			if (newIndex != null)
				msgs = ((InternalEObject)newIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_DTO__INDEX, null, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_DTO__PROPERTIES: return MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES: return MobaPackage.MOBA_DTO__PROPERTIES;
				default: return -1;
			}
		}
