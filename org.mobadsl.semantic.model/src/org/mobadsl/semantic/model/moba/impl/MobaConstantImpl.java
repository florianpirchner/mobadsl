 ...
 * <ul>
 * <li>
 * {@link org.mobadsl.semantic.model.moba.impl.MobaConstantImpl#getProperties
 * <em>Properties</em>}</li>
 * <li>{@link org.mobadsl.semantic.model.moba.impl.MobaConstantImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link org.mobadsl.semantic.model.moba.impl.MobaConstantImpl#getValueAST
 * <em>Value AST</em>}</li>
 * </ul>
 *
 * @generated
...
public class MobaConstantImpl extends MobaApplicationFeatureImpl implements MobaConstant {
	...
	/**
	 * The cached value of the '{@link #getValueAST() <em>Value AST</em>}'
	...
	public EList<MobaProperty> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<MobaProperty>(MobaProperty.class, this,
					MobaPackage.MOBA_CONSTANT__PROPERTIES);
		}
		return properties;
	}
	...
	public NotificationChain basicSetValueAST(MobaConstantValue newValueAST, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MobaPackage.MOBA_CONSTANT__VALUE_AST, oldValueAST, newValueAST);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setValueAST(MobaConstantValue newValueAST) {
		if (newValueAST != valueAST) {
			...
			if (valueAST != null)
				msgs = ((InternalEObject) valueAST).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_CONSTANT__VALUE_AST, null, msgs);
			if (newValueAST != null)
				msgs = ((InternalEObject) newValueAST).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - MobaPackage.MOBA_CONSTANT__VALUE_AST, null, msgs);
			msgs = basicSetValueAST(newValueAST, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_CONSTANT__VALUE_AST, newValueAST,
					newValueAST));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesAble.class) {
			...
			case MobaPackage.MOBA_PROPERTIES_ABLE__PROPERTIES:
				return MobaPackage.MOBA_CONSTANT__PROPERTIES;
			default:
				return -1;
			}
		}
