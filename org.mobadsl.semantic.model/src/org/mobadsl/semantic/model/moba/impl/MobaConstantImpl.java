 ...
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaConstantImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaConstantImpl extends MobaApplicationFeatureImpl implements MobaConstant {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_CONSTANT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MobaPackage.MOBA_CONSTANT__NAME:
				return getName();
			case MobaPackage.MOBA_CONSTANT__VALUE:
				return getValue();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_CONSTANT__PROPERTIES: return MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaPropertiesProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES: return MobaPackage.MOBA_CONSTANT__PROPERTIES;
				default: return -1;
			}
		}
