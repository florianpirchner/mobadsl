	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MobaMultiplicityProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_PAYLOAD_ATTRIBUTE__MULTIPLICITY: return MobaPackage.MOBA_MULTIPLICITY_PROVIDER__MULTIPLICITY;
				default: return -1;
			}
		}
		if (baseClass == MobaPropertiesProvider.class) {
			switch (derivedFeatureID) {
				case MobaPackage.MOBA_PAYLOAD_ATTRIBUTE__PROPERTIES: return MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MobaMultiplicityProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_MULTIPLICITY_PROVIDER__MULTIPLICITY: return MobaPackage.MOBA_PAYLOAD_ATTRIBUTE__MULTIPLICITY;
				default: return -1;
			}
		}
		if (baseClass == MobaPropertiesProvider.class) {
			switch (baseFeatureID) {
				case MobaPackage.MOBA_PROPERTIES_PROVIDER__PROPERTIES: return MobaPackage.MOBA_PAYLOAD_ATTRIBUTE__PROPERTIES;
				default: return -1;
			}
		}
