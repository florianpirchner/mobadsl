 ...
 * <ul>
 * <li>
 * {@link org.mobadsl.semantic.model.moba.impl.MobaGeneratorImpl#getGeneratorString
 * <em>Generator String</em>}</li>
 * <li>
 * {@link org.mobadsl.semantic.model.moba.impl.MobaGeneratorImpl#getGeneratorConst
...
public class MobaGeneratorImpl extends MobaApplicationFeatureImpl implements MobaGenerator {
	/**
	 * The default value of the '{@link #getGeneratorString()
	...
	/**
	 * The cached value of the '{@link #getGeneratorString()
	 * <em>Generator String</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getGeneratorString()
	...
	/**
	 * The cached value of the '{@link #getGeneratorConst()
	...
	public void setGeneratorString(String newGeneratorString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_GENERATOR__GENERATOR_STRING,
					oldGeneratorString, generatorString));
	}
			...
			if (generatorConst != oldGeneratorConst) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MobaPackage.MOBA_GENERATOR__GENERATOR_CONST, oldGeneratorConst, generatorConst));
			}
		}
	...
	public void setGeneratorConst(MobaConstant newGeneratorConst) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_GENERATOR__GENERATOR_CONST,
					oldGeneratorConst, generatorConst));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MobaPackage.MOBA_GENERATOR__GENERATOR_STRING:
			return GENERATOR_STRING_EDEFAULT == null ? generatorString != null
					: !GENERATOR_STRING_EDEFAULT.equals(generatorString);
		case MobaPackage.MOBA_GENERATOR__GENERATOR_CONST:
