 ...
 * </p>
 * <ul>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaMinConstraintImpl#getFilterValue <em>Filter Value</em>}</li>
 *   <li>{@link org.mobadsl.semantic.model.moba.impl.MobaMinConstraintImpl#getFilterConst <em>Filter Const</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MobaMinConstraintImpl extends MobaConstraintImpl implements MobaMinConstraint {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(MobaMinConstraintImpl.class);
	 ...
	 * @generated
	 */
	protected MobaMinConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MobaPackage.Literals.MOBA_MIN_CONSTRAINT;
	}
	...
	public MobaConstant getFilterConst() {
		if (filterConst != null && filterConst.eIsProxy()) {
			...
			if (filterConst != oldFilterConst) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MobaPackage.MOBA_MIN_CONSTRAINT__FILTER_CONST, oldFilterConst, filterConst));
			}
		}
		return filterConst;
	}
	...
	public void setFilterConst(MobaConstant newFilterConst) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MobaPackage.MOBA_MIN_CONSTRAINT__FILTER_CONST, oldFilterConst, filterConst));
	}
